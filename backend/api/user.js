...
module.exports = app => {
    ...
    const save = async (req, res) => {
        ...
        try {
            ...
            existsOrError(user.email, 'E-mail not entered');
            existsOrError(user.password, 'Password not entered');
            existsOrError(user.confirmPassword, 'Password confirmation not entered');
    ...
    const limit = 3 // used to pagination
    ...
    const remove = async (req, res) => {
        try {
            ...
            notExistsOrError(articles, 'Users has articles.')
