    ...
    <div class="category-admin">
        <b-form>
            ...
            <b-form-group label="Name:" label-for="category-name">
                <b-form-input id="category-name" type="text" v-model="category.name" placeholder="Inform category name..." 
            ...
            <b-form-group label="Father Category:" label-for="category-parentId">
                ...
                <b-form-input v-else id="category-parentId" type="text" v-model="category.path" :readonly="mode === 'remove'" required />
            </b-form-group>
